...
urlpatterns = [
    # guest urls
    path('',getLayout, name='main'),
    path('about_us/', getAboutUsPage, name='about_us'),
    ...
    path('account/themes_inst/', getThemesTestListPage, name = "user_themes"),
    path('account/profile/', getProfile, name="profile"),
