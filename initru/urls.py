...
urlpatterns = [
    ...
    path(
        ...
        name="check_down_load",
    ),
    path(
        "account/themes_inst/test/<int:id>/check/",
        BriefBrainView.checkPassed,
        name="check_passed_view",
    ),
    path(
        "account/themes_inst/test/<int:id>/<int:num>/save",
        BriefBrainView.save,
        name="save_data_test",
    ),
    path(
        "account/themes_inst/test/<int:id>/<int:num>/data",
        BriefBrainView.questions,
        name="get_data_test",
    ),
